...
## 6. Alvos Máximos por Timeframe (Aplicação com ATR)

Mesmo usando canal de volatilidade, manter um teto de objetivo por timeframe:
...
### Integração com ATR
- Se o ATR estiver em contração, priorizar alvos no **piso** da faixa.
- Se o ATR estiver em expansão direcional, pode buscar **meio/topo** da faixa.
- Após atingir alvo intermediário, proteger posição com stop técnico na média central ou trailing.